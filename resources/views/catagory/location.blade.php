...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="{{ route('location.store') }}" enctype="multipart/form-data" class="p-5 bg-white">
    @csrf
      <div class="row form-group">
        ...
        <div class="row form-group mb-5">
            ...
            <input type="text" name="location" value=""  id="fullname" class="form-control" placeholder="Location">
            </div>
        </div>
