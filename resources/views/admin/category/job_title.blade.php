...
<div class="panel-body pn">
    ...
    <div class="col-md-12 no-padding">
        <form method="GET" action="\search_category">
        ...
        @foreach ($category as $data)
            ...
            <td>{{ $data->title}}</td>
                <td class="icon-button">
                    ...
                    <a title="edit" href="{{ route('admincategory.edit', $data)}}" style="margin-left: 10%"><span class="fa fa-pencil"></span> </a> |

                    <a class="delete_confirm" href="{{ url('/category/'.$data->id.'/destroy') }}" onclick="return confirm('Are you sure you want to delete this item?');"><span class="fa fa-trash"></span> </a>
                </td>
            </tr>
        @endforeach
        </tbody>
