...
@endif
<form method="post" id="form" action="{{ route('adminjobtype.update', $jobtype)}}" enctype="multipart/form-data" style="margin:80px" >
    ...
    <div class="form-group">
        ...
        <div class="col1">
            <input type="text" name="job_type" value="{{ $jobtype->job_type}}" class="form-control input-lg" style="margin-left: -150px"/>
        </div>
